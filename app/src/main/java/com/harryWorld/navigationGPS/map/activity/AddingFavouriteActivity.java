...
public class AddingFavouriteActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void updatingPlace(com.harryWorld.navigationGPS.map.utils.Places places){
    ...
    private void insertingPlace(com.harryWorld.navigationGPS.map.utils.Places places) {
    ...
    private void setPlaces(){
        placesViewModel.getPlaces.observe(this, new Observer<List<com.harryWorld.navigationGPS.map.utils.Places>>() {
            @Override
