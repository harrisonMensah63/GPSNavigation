...
import com.harryWorld.navigationGPS.map.recyclerVeiw.ListAdapter;
import com.harryWorld.navigationGPS.map.recyclerVeiw.SearchAdapter;
...
import static com.harryWorld.navigationGPS.map.constant.Constant.FROM_SEARCH;
import static com.harryWorld.navigationGPS.map.constant.Constant.FROM_SEARCH_FIRST;
import static com.harryWorld.navigationGPS.map.constant.Constant.FROM_SEARCH_SECOND;
...
import static com.harryWorld.navigationGPS.map.constant.Constant.MAIN_SEARCH_NAVIGATION;
...
//        });
    ...
    private void setPlaces(){
        viewModel.getPlaces.observe(this, new Observer<List<com.harryWorld.navigationGPS.map.utils.Places>>() {
            @Override
            public void onChanged(List<com.harryWorld.navigationGPS.map.utils.Places> places) {
                if (places != null){
                    if (places.size() > 0 ) {
...
//    }
        ...
        Schedule schedule;
        com.harryWorld.navigationGPS.map.utils.Places places = new com.harryWorld.navigationGPS.map.utils.Places();
        ...
        if (getIntent().hasExtra(MAIN_SEARCH)){
            ...
            com.harryWorld.navigationGPS.map.utils.Places place = getIntent().getParcelableExtra(FROM_SEARCH);
        ...
        if (getIntent().hasExtra(EMPTY_SEARCH)){
            com.harryWorld.navigationGPS.map.utils.Places place = getIntent().getParcelableExtra(EMPTY_SEARCH);
            place.setLatitude(latitude);
            place.setLongitude(longitude);
            place.setCityName(county);
            place.setContent(label);
