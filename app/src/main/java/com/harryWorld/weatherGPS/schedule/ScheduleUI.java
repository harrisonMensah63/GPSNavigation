...
import com.harryWorld.weatherGPS.map.notification.AlertReceiver;
import com.harryWorld.weatherGPS.map.notification.InstantReceiver;
...
public class ScheduleUI extends AppCompatActivity implements
        ScheduleAdapter.MyViewHolder.ScheduleListener, ScheduleAdapter.MyViewHolder.AlarmListener {
    ...
    private void actionBarFloat(){
        floatingActionButton.setBackgroundColor(getResources().getColor(R.color.tab_light));
    ...
    private void creatingChannel(){
        ...
        nc.setLightColor(R.color.tab_light);
    ...
    private void setRecyclerView(){
        ...
        Decoration decoration = new Decoration(15);
            ...
            public void onChanged(List<Schedule> schedules) {
                if (schedules != null){
                    if (schedules.size() >0) {
                        ...
                        adapter.notifyItemRangeChanged(0, schedules.size());
    ...
    private void updateAlarm(Alarm alarm, int position){
