...
import com.harryWorld.weatherGPS.map.retrofit.DirectionsJSONParser;
   ...
   public List<LatLng> categoriesList = new ArrayList<>();
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
        ...
        protected List<List<HashMap<String, String>>> doInBackground(String... jsonData) {
            ...
            try {
                jObject = new JSONObject(jsonData[0]);
                com.harryWorld.weatherGPS.map.retrofit.DirectionsJSONParser parser = new DirectionsJSONParser();
